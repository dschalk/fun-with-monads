...
` ),  
  ...
  add = (x,mon,y) => {mon.ret(x + y);
    return mon;
      ...
      h('p', 'GOAL: Pass mM1\'s value to mM2 and cube it, leaving mM1\'s value unchanged and using the ordinar function cu, defined as ' ),
      ...
      h('button', {on: { mouseenter: update6e, mouseleave: update6l, click: update2B2 }, style: style6},
               `mM1.ret(3).fmap( _ => {var a = mM1.x; mM2.ret(a).fmap(cu); return a})`  ), 
      h('p', 'But defining the specialized function "cube" wasn\'t much work, and the following code is ever so much more elegant than the fmap solutions: '  ),

      h('button', {on: { mouseenter: update4e, mouseleave: update4l, click: update2B3 }, style: style4},
