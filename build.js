...
var test2 = (0, _snabbdomH2['default'])('pre', { style: { color: '#AFEEEE' } }, '\n');
...
exports['default'] = { monad: monad, monadIter: monadIter, steps: steps, next: next, test: test, functions1: functions1 };
...
function updateDemo1() {
  mM2.ret(mM1.bnd(add, 1).bnd(square) === mM1.bnd(function (val) {
    return cube(square(val, mM1, 1).x, mM1);
  }));
  update0();
}
